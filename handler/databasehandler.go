...
type Database interface {
	...
	GetAllCards(ctx context.Context) ([]domain.PokemonCard, error)
	AddUserCollectionCard(ctx context.Context, cardID, collectionID int) error
	GetCardById(ctx context.Context, cardID string) (domain.PokemonCard, error)
...
func (d DatabaseHandler) GetAllCards(ctx context.Context) ([]domain.PokemonCard, error) {
...
func (d DatabaseHandler) GetCardById(ctx context.Context, cardID string) (domain.PokemonCard, error) {
